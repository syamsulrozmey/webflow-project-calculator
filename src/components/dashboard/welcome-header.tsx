    ...
    <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          {activeProjects > 0 ? (
            <>
              You have <span className="text-white">{activeProjects} active project{activeProjects !== 1 ? "s" : ""}</span> worth{" "}
              <span className="text-white">{formatCurrency(pipelineValue)}</span>
            </>
          ) : (
      ...
      <div className="hidden sm:block">
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-64 border-white/10 bg-zinc-900 p-2">
            <DropdownMenuItem 
      ...
      <div className="flex gap-2 sm:hidden">
        ...
        <Button asChild size="sm" variant="outline" className="flex-1 border-white/20">
          <Link href="/analysis">
